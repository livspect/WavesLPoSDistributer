   ...
   getBlocks: function()
   {
      ...
      function getBlocks(range)
      {
         return new Promise(function(resolve, reject)
         {
            ...
            request.get({url: worker.node + "/blocks/seq/" + range.start + "/" + range.end, json: true, timeout: 20000, headers:{"Connection": "keep-alive", "Accept": "application/json", "Content-Type": "application/json"}}, function(error, response, body)
            {
               if(error)
               {
