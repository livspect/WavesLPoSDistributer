...
(5, 'last distributed block', 1),
(6, 'end distribute block', 1),
(7, 'first block stat', 1),
(8, 'last block stat', 1);
...
CREATE TABLE `richlist` (
  `id_richlist` int(10) UNSIGNED NOT NULL,
  `address` varchar(36) NOT NULL,
...
--
-- Indexes for table `richlist`
--
ALTER TABLE `richlist`
  ADD PRIMARY KEY (`id_richlist`);
...
ALTER TABLE `transaction`
  ADD PRIMARY KEY (`id_transaction_type`,`date`);
...
--
ALTER TABLE `block`
  MODIFY `id_block` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5280;

--
-- AUTO_INCREMENT for table `config`
--
ALTER TABLE `config`
  MODIFY `id_config` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `distribution`
--
ALTER TABLE `distribution`
  MODIFY `id_distribution` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=167;

--
-- AUTO_INCREMENT for table `journal_line`
--
ALTER TABLE `journal_line`
  MODIFY `id_journal_line` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=221408;

--
-- AUTO_INCREMENT for table `lease`
--
ALTER TABLE `lease`
  MODIFY `id_lease` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1708;
...
--
-- AUTO_INCREMENT for table `richlist`
--
ALTER TABLE `richlist`
  MODIFY `id_richlist` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3320;
COMMIT;
